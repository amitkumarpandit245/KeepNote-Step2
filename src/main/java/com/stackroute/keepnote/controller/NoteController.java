...
public class NoteController {
	 ...
	 */
	@GetMapping("/")
	public ModelAndView getAllNotes(ModelMap model) {
	...
	@PostMapping("/add")
	public ModelAndView addNote(ModelMap modelMap,@RequestParam String noteTitle, @RequestParam String noteContent, @RequestParam String noteStatus) {			
	...
	public ModelAndView deleteNote(ModelMap modelMap, @RequestParam int noteId) {
	...
	public String update(ModelMap modelMap,@RequestParam int noteId) {
		modelMap.addAttribute("note", noteDao.getNoteById(noteId));
		return "update";
